...
<html lang="en">
  ...
  <body>
    ...
    <div class="main container">
        ...
        <h2 class='login_title text-center'>Регистрация</h2>
        <hr>
            <form class="form-signin" id="register" method="post" action="/auth/register.php">
                <span id="reauth-email" class="reauth-email"></span>
                <p class="input_title">Логин</p>
                <input type="text" id="inputLogin" name="login" class="login_box" placeholder="" required autofocus>
                 <p class="input_title">Email</p>
                <input type="text" id="inputEmail" name="email" class="login_box" placeholder="" required>
                ...
                <input type="password" name="secondPassword" class="login_box inputPassword" placeholder="******" required>
